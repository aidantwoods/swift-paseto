...
class Version2VectorTest: XCTestCase {
    ...
    func testEncrypt() {
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                emptyMessage, with: nullKey, footer:emptyFooter, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                emptyMessage, with: fullKey, footer:emptyFooter, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                emptyMessage, with: symmetricKey, footer:emptyFooter, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                emptyMessage, with: nullKey, footer: footer1, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                emptyMessage, with: fullKey, footer: footer1, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                emptyMessage, with: symmetricKey, footer: footer1, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                message1, with: nullKey, footer: emptyFooter, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                message1, with: fullKey, footer: emptyFooter, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                message1, with: symmetricKey, footer: emptyFooter, nonce: nonce1
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                message1, with: nullKey, footer: footer1, nonce: nonce2
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                message1, with: fullKey, footer: footer1, nonce: nonce2
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                message1, with: symmetricKey, footer: footer1, nonce: nonce2
            ).asString
        )
        ...
        XCTAssertEqual(
            ...
            Version2.encrypt(
                message2, with: symmetricKey, footer: footer2, nonce: nonce2
            ).asString
        )
    }
